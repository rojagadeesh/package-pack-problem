...
public class Package {
    ...
    void packing() {
        ...
        for (int i = 0; i < key.size(); i++) {
            ...
            int tempPrice2 = p.price;// get packet from inner loop
            float tempWeight4 = p.weight;
            int tempPrice4 = p.price;// for other combinations in the inner loop
